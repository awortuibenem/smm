                    ...
                    <form method="POST">
                        <div class="form-group icon-left">
                            ...
                            <div class="input_group">
                                <input type="email" name="login_email" class="form-control" placeholder='e. g. "example@mail.com"'
                                    required>
                                <div class="icon">
                        ...
                        <div class="form-group icon-left">
                            ...
                            <div class="input_group">
                                <input type="password" name="login_password" class="form-control" placeholder='e. g. "John$99*04"' required>
                                <div class="icon">
